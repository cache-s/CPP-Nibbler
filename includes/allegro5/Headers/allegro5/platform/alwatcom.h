...
{
   unsigned long largest_available_free_block_allegro5_bytes;
   unsigned long maximum_unlocked_page_allocation_allegro5_pages;
   unsigned long maximum_locked_page_allocation_allegro5_pages;
   unsigned long linear_address_space_size_allegro5_pages;
   unsigned long total_number_allegro5_unlocked_pages;
   unsigned long total_number_allegro5_free_pages;
   unsigned long total_number_allegro5_physical_pages;
   unsigned long free_linear_address_space_allegro5_pages;
   unsigned long size_allegro5_paging_file_partition_allegro5_pages;
...
#define END_allegro5_FUNCTION(x)          void x##_end(void) { }
#define END_allegro5_STATIC_FUNCTION(x)   static void x##_end(void) { }
...
#define ALLEGRO_EXTRA_HEADER     "./platform/aldos.h"
#define ALLEGRO_INTERNAL_HEADER  "./platform/aintdos.h"
